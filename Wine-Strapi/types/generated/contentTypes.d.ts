...
export interface ApiAdresseAdresse extends Schema.CollectionType {
  ...
  attributes: {
    ...
    >;
    Prix_moyen: Attribute.Integer;
    Maps_url: Attribute.String;
    ...
    host: Attribute.Relation<
      ...
      'api::host.host'
    >;
    Type: Attribute.Component<'adresse.type', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiHostHost extends Schema.CollectionType {
  ...
  attributes: {
    ...
    mail: Attribute.Email & Attribute.Private & Attribute.Unique;
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::host.host', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::host.host', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}

export interface ApiTypeType extends Schema.SingleType {
  ...
  attributes: {
    Type: Attribute.DynamicZone<['adresse.type']>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
